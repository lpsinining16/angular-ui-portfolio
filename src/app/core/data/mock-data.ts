// This file contains the local fallback data for the portfolio.
...
export const skills = [
  ...
  { id: 5, category: 'Testing', technologies: ['Selenium'] },
  { id: 6, category: 'Methodologies', technologies: ['Agile/Scrum'] },
] as const;
...
export const projects = [
  ...
  },
  {
    ...
    company: 'Intellicare - Asalus Corporation',
    link: '',
    description: 'Developed a series of internal web applications...',
  ...
  },
  {
    ...
    type: 'personal', // This will now be inferred as type 'personal'
    company: '',
    link: '/',
  ...
  },
  {
    ...
    company: '',
    link: '',
    description: 'A detailed case study of the enterprise-grade application suite...',
    technologies: ['Angular', 'PrimeNG', 'Bootstrap', 'TypeScript', 'Spring Boot', 'Selenium'],
     systems: [
      {
        title: "Casino Management System (CMS)",
  ...
  },
  {
    ...
    company: '',
    link: '',
    description: 'A showcase of internal web applications...',
    technologies: ['Angular', 'Angular Material', 'ASP.NET C#', 'RESTful APIs', 'MS SQL Server'],
    systems: [
      {
        title: "Clinic Management Portal",
